...
<head>
	...
	<title>Dépot - Plateforme Crypto</title>
	<link rel="stylesheet" href="styles.css">
	<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
	<!-- Inclusion du fichier JavaScript -->
	<script type="module" src="depot.js"></script>
...
<body>
	...
	<section id="retrait">
		...
		<form action="insertDepot" method="post" class="retrait-form">
			<div class="form-group">
			  <label for="solde">Montant du dépôt :</label>
	...
	<footer>
		<p>© 2025 Plateforme Crypto. Tous droits réservés.</p>
	</footer>
