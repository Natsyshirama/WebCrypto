<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<title>Liste des Demandes de Validation de Retrait</title>
			<link rel="stylesheet" href="retrait.css">
			<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
							<script type="module" src="valideRetrait.js"></script>
		...
		<body>
			...
			<section id="liste-retraits">
				<h1>Liste des Retraits Non Validés</h1>
				...
				<table class="retrait-table">
					...
					<tbody>
						<c:forEach var="retrait" items="${retraits}">
							<tr>
								<td>${retrait.idRetrait}</td>
								<td>${retrait.solde}</td>
								<td>${retrait.daty}</td>
								<td>${retrait.idUtilisateur}</td>
								<td>
									<form action="valideRetrait" method="post">
										<input type="hidden" name="idRetrait" value="${retrait.idRetrait}">
